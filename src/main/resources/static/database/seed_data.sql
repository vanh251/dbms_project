...
-- 4. COURSES
-- -------------------------------------------------------
INSERT INTO "courses" (id, name, slug, description, require, total_lession, total_part, total_time, price, old_price, category_id, status) VALUES
(1,
...
-- 5. PARTS OF COURSES
-- -------------------------------------------------------
INSERT INTO "part_of_courses" (id, course_id, name) VALUES
...
-- -------------------------------------------------------
INSERT INTO "lessions" (id, name, course_id, part_id, length, description, value) VALUES
...
-- -------------------------------------------------------
UPDATE "users" SET permission = '1,3'     WHERE id = 2;
UPDATE "users" SET permission = '1,2,3,4' WHERE id = 3;

-- -------------------------------------------------------
-- 8. BÌNH LUẬN MẪU
-- -------------------------------------------------------
INSERT INTO "comments" (user_id, lession_id, content, parent_id) VALUES
