...
public interface CourseRepository extends JpaRepository<Course, Integer> {
    ...
    @Procedure(procedureName = "sp_create_course", outputParameterName = "p_new_course_id")
    Integer createCourse(String p_name, String p_slug, String p_thumbnail, String p_description, String p_require, String p_price, String p_old_price, String p_total_time, Integer p_category_id);
